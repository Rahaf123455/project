...
class ExitIntentTracker {
  ...
  registerPostMessageReceivers(postMessageReceiver) {
    postMessageReceiver.register(_receivedPostMessageTypes.START_TRACK_EXIT_INTENT, this.add.bind(this));
    postMessageReceiver.register(_receivedPostMessageTypes.STOP_TRACK_EXIT_INTENT, this.remove.bind(this));
  }
