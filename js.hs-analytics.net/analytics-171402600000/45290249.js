...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setPortalId', 45290249]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addHashedCookieDomain', '224894981']);
_hsq.push(['addHashedCookieDomain', '20629287']);
_hsq.push(['addHashedCookieDomain', '251652889']);
_hsq.push(['addHashedCookieDomain', '11455275']);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/45290249.js', 'hs-script-loader']);
...
(function() {
    ...
    ;
    hstc.utils.checkHashedDomain = function(t, e) {
        return 0 == t.length || -1 == t.substring(1).indexOf(".") ? "" : 0 != t.indexOf(".") && hstc.utils.inArray("" + this.hashString("." + t), e) > -1 ? "." + t : hstc.utils.inArray("" + this.hashString(t), e) > -1 ? t : this.checkHashedDomain(t.substring(t.substring(1).indexOf(".") + 1), e)
    }
    ;
    ...
    hstc.cookies.Cookie.prototype.addHashedDomain = function(t) {
        ...
        var e = hstc.utils.checkHashedDomain(this.context.getHostName(), t.split());
    ...
    !function(t) {
        var e, i, n, r, s, o, c, a, h, u, l, g, p, f, d, k, m, y = "sizzle" + -new Date, v = t.document, C = 0, _ = 0, T = rt(), w = rt(), x = rt(), S = !1, b = function(t, e) {
            ...
            return 0
        }, E = "undefined", D = 1 << 31, I = {}.hasOwnProperty, L = [], A = L.pop, N = L.push, O = L.push, P = L.slice, R = L.indexOf || function(t) {
            for (var e = 0, i = this.length; e < i; e++)
                if (this[e] === t)
                    return e;
            return -1
        }
        , U = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", q = H.replace("w", "w#"), F = "\\[" + M + "*(" + H + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + q + ")|)|)" + M + "*\\]", j = ":(" + H + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + F.replace(3, 8) + ")*)|.*)\\)|)", B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), V = new RegExp("^" + M + "*," + M + "*"), $ = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), K = new RegExp(M + "*[+~]"), W = new RegExp("=" + M + "*([^\\]'\"]*)" + M + "*\\]","g"), G = new RegExp(j), z = new RegExp("^" + q + "$"), Y = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
        ...
        function Ct(t, e) {
            var i = 0
              ...
              , c = function(c, h, u, g, p) {
                var f, d, k, m = [], y = 0, v = "0", _ = c && [], T = null != p, w = a, x = c || o && r.find.TAG("*", p && h.parentNode || h), S = C += null == w ? 1 : Math.random() || .1, b = x.length;
                if (T) {
                    a = h !== l && h;
                    n = i
                }
                ...
                if (null !== t)
                    if (e && t.forEach === e)
                        ...
                        for (var r = 0, s = t.length; r < s; r++)
                            if (i.call(n, t[r], r, t) === undefined)
                                return
                    } else
                        for (var o in t)
                            if (t.hasOwnProperty(o) && i.call(n, t[o], o, t) === undefined)
                                return
            }
            ;
