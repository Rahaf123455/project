...
_hsp.push(['addCookieDomain', '.bgautooffer.com']);
                ...
                if (null != (s = this.transformers[t]({
                    ...
                    if (s.whitelist_nodes && s.whitelist_nodes instanceof Array)
                        for (i = 0; i < s.whitelist_nodes.length; i++)
                            -1 == n(s.whitelist_nodes[i], this.whitelist_nodes) && this.whitelist_nodes.push(s.whitelist_nodes[i]);
...
, function(e, t, n) {
    ...
    class G {
        ...
        test(e, t, n, o) {
            ...
            if (!e.startsWith(this.targetedPathPrefix))
                return R;
            if (!o && this.wildcard)
                return R;
        ...
        static fromJS(e) {
            const {allUrlsAndLocations: t, path: n, targetedCountries: o, targetedRegions: i} = e;
    ...
    class X {
        ...
        static fromJS(e) {
            const {id: t, portalId: n, label: o, enabled: i, configuration: s, policy: r, legacyCustomization: a, gpcSettings: c} = e;
    ...
    class le {
        ...
        set(e, t, n) {
            ...
            if ((n = n || {}).minsToExpire) {
                ...
                n.expiryDate && n.expiryDate.toGMTString ? o = n.expiryDate : n.expiryDate && (o = new Date(n.expiryDate));
            if (void 0 !== o) {
                i = o.toGMTString();
                s = !0
            }
    ...
    var ue, ge, _e, fe, me, pe, be = {}, ye = [], ve = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
    function Ce(e, t) {
        for (var n in t)
            e[n] = t[n];
        return e
    ...
    function Se(e, t, n) {
        ...
        if (arguments.length > 2 && (r.children = arguments.length > 3 ? ue.call(arguments, 2) : n),
        "function" == typeof e && null != e.defaultProps)
            for (s in e.defaultProps)
                void 0 === r[s] && (r[s] = e.defaultProps[s]);
    ...
    function we(e, t, n, o, i) {
        ...
        return null == i && null != ge.vnode && ge.vnode(s),
        s
    }
    function Te(e) {
        return e.children
    ...
    function Ae() {
        for (var e; Ae.__r = fe.length; )
            ...
            e.some((function(e) {
                ...
                (r = t.__P) && (n = [],
                (o = Ce({}, i)).__v = i.__v + 1,
                Ue(r, i, o, t.__n, void 0 !== r.ownerSVGElement, null != i.__h ? [s] : null, n, null == s ? Oe(i) : s, i.__h),
                Fe(n, i),
                i.__e != s && Ee(i)))
            }
            ))
    ...
    function Le(e, t, n, o, i, s, r, a, c, l) {
        var h, d, u, g, _, f, m, p = o && o.__k || ye, b = p.length;
        for (n.__k = [],
        h = 0; h < t.length; h++)
            if (null != (g = n.__k[h] = null == (g = t[h]) || "boolean" == typeof g ? null : "string" == typeof g || "number" == typeof g || "bigint" == typeof g ? we(null, g, null, null, g) : Array.isArray(g) ? we(Te, {
                ...
                m.push(d, g.__c || _, g)),
                null != _ ? (null == f && (f = _),
                "function" == typeof g.type && g.__k === u.__k ? g.__d = c = Ne(g, c, e) : c = Be(e, g, u, p, _, c),
                "function" == typeof n.type && (n.__d = c)) : c && u.__e == c && c.parentNode != e && (c = Oe(u))
            }
        for (n.__e = f,
        h = b; h--; )
            null != p[h] && ("function" == typeof n.type && null != p[h].__e && p[h].__e == n.__d && (n.__d = Oe(o, h + 1)),
            He(p[h], p[h]));
        if (m)
    ...
    function Ne(e, t, n) {
        for (var o, i = e.__k, s = 0; i && s < i.length; s++)
            (o = i[s]) && (o.__ = e,
            t = "function" == typeof o.type ? Ne(o, t, n) : Be(n, o, o, i, o.__e, t));
        return t
    }
    function Be(e, t, n, o, i, s) {
        ...
        if (void 0 !== t.__d)
            ...
            e: if (null == s || s.parentNode !== e)
                ...
                for (a = s,
                c = 0; (a = a.nextSibling) && c < o.length; c += 2)
                    if (a == i)
                        break e;
                e.insertBefore(i, s),
                r = s
    ...
    function Re(e, t, n, o, i) {
        ...
        for (s in t)
            i && "function" != typeof t[s] || "children" === s || "key" === s || "value" === s || "checked" === s || n[s] === t[s] || De(e, s, t[s], n[s], o)
    }
    function Pe(e, t, n) {
    ...
    function De(e, t, n, o, i) {
        ...
        e: if ("style" === t)
            if ("string" == typeof n)
                ...
                o)
                    for (t in o)
                        n && t in n || Pe(e.style, t, "");
                if (n)
                    for (t in n)
                        o && n[t] === o[t] || Pe(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1])
            ...
            e.l || (e.l = {}),
            e.l[t + s] = n,
            n ? o || e.addEventListener(t, s ? Me : Ge, s) : e.removeEventListener(t, s ? Me : Ge, s);
    ...
    function Ue(e, t, n, o, i, s, r, a, c) {
        ...
        try {
            e: if ("function" == typeof v) {
                ...
                n.__c ? f = (h = t.__c = n.__c).__ = h.__E : ("prototype"in v && v.prototype.render ? t.__c = h = new v(m,b) : (t.__c = h = new ke(m,b),
                h.constructor = v,
                h.render = ze),
                p && p.sub(h),
                h.props = m,
                ...
                null != v.getDerivedStateFromProps && (h.__s == h.state && (h.__s = Ce({}, h.__s)),
                Ce(h.__s, v.getDerivedStateFromProps(m, h.__s))),
                u = h.props,
                g = h.state,
                d)
                    null == v.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(),
                    null != h.componentDidMount && h.__h.push(h.componentDidMount);
                else {
                    if (null == v.getDerivedStateFromProps && m !== u && null != h.componentWillReceiveProps && h.componentWillReceiveProps(m, b),
                    !h.__e && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(m, h.__s, b) || t.__v === n.__v) {
                        h.props = m,
                        h.state = h.__s,
                        t.__v !== n.__v && (h.__d = !1),
                        h.__v = t,
                ...
                h.state = h.__s,
                null != h.getChildContext && (o = Ce(Ce({}, o), h.getChildContext())),
                d || null == h.getSnapshotBeforeUpdate || (_ = h.getSnapshotBeforeUpdate(u, g)),
                y = null != l && l.type === Te && null == l.key ? l.props.children : l,
                ...
                t.__e = n.__e) : t.__e = Ye(n.__e, t, n, o, i, s, r, c);
            (l = ge.diffed) && l(t)
        } catch (e) {
            t.__v = null,
            (c || null != s) && (t.__e = a,
    ...
    function Ye(e, t, n, o, i, s, r, a) {
        var c, l, h, d = n.props, u = t.props, g = t.type, _ = 0;
        if ("svg" === g && (i = !0),
        null != s)
            for (; _ < s.length; _++)
        ...
        if (null == e) {
            ...
            e = i ? document.createElementNS("http://www.w3.org/2000/svg", g) : document.createElement(g, u.is && u),
            s = null,
            a = !1
        }
        if (null === g)
            ...
            h)
                t.__k = [];
            else if (_ = t.props.children,
            Le(e, Array.isArray(_) ? _ : [_], t, n, o, i && "foreignObject" !== g, s, r, s ? s[0] : n.__k && Oe(n, 0), a),
            null != s)
                for (_ = s.length; _--; )
                    null != s[_] && xe(s[_]);
            a || ("value"in u && void 0 !== (_ = u.value) && (_ !== e.value || "progress" === g && !_ || "option" === g && _ !== d.value) && De(e, "value", _, d.value, !1),
            "checked"in u && void 0 !== (_ = u.checked) && _ !== e.checked && De(e, "checked", _, d.checked, !1))
        }
        return e
    }
    function Ve(e, t, n) {
    ...
    function We(e, t, n) {
        ...
        s = [],
        Ue(t, e = (!o && n || t).__k = Se(Te, null, [e]), i || be, be, void 0 !== t.ownerSVGElement, !o && n ? [n] : i ? null : t.firstChild ? ue.call(t.childNodes) : null, s, !o && n ? n : i ? i.__e : t.firstChild, o),
        Fe(s, e)
    }
    ue = ye.slice,
    ge = {
    ...
    ke.prototype.setState = function(e, t) {
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = Ce({}, this.state),
    ...
    fe = [],
    me = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout,
    Ae.__r = 0,
    0;
    var $e, qe, Ke, je = 0, Je = [], Qe = ge.__b, Ze = ge.__r, Xe = ge.diffed, et = ge.__c, tt = ge.unmount;
    function nt(e, t) {
        ge.__h && ge.__h(qe, e, je || t),
        je = 0;
        var n = qe.__H || (qe.__H = {
            __: [],
            __h: []
    ...
    function it(e, t, n) {
        var o = nt($e++, 2);
        return o.t = e,
        o.__c || (o.__ = [n ? n(t) : gt(void 0, t), function(e) {
            var t = o.t(o.__[0], e);
    ...
    function bt({context: e, onAcceptAll: t, onCookieSettingsClick: n, onDeclineAll: o, setting: i, onCloseBannerButtonClick: s, isModalDisplayed: r}) {
        const a = rt(null)
          , c = rt(null)
          , l = rt(null)
          , h = rt(null)
    ...
    function yt({category: e, disabled: t, onToggleChange: n, toggleValue: o}) {
    ...
    function xt({category: e, onToggleChange: t, sectionText: n, toggleValue: o, modalBodyRef: i}) {
        const [s,r] = ot(!1)
          , a = e === p.NECESSARY
          , c = rt(null)
          , l = rt(null)
    ...
    function At({accentColor: e, consent: t, context: n, modalText: o, onAcceptCategories: i, onCloseModal: s}) {
        const r = rt(null)
          , a = rt(null)
          , c = rt(null)
          , l = rt(null);
    ...
    function Lt({apiBaseUrl: e, consent: t, setting: n, context: o, onConsentChange: i, onCloseBannerWithoutConsent: s, dismissNotifyBanner: r}) {
        const [a,c] = ot(!1)
          , l = e=>{
            if (e !== J.NOTIFY) {
                t.update(!0);
    ...
    const on = e=>e.stack ? nn.parse(e.stack).map(e=>({
      ...
      , Cn = (e,t,n)=>{
        try {
            if (!e.hsCookieBanner || !e.hsCookieBanner.rawPerfMetrics)
                return;
    ...
    const Sn = (e,t)=>!!(e && !w.includes(e) || t && J.isOptIn(t))
      ...
      , Tn = e=>fetch(e).then(t=>{
        if (!t.ok)
            throw new Error(`Non-2XX status: ${t.status}, url: ${e}`);
        return t.text()
    }
    )
      , kn = async e=>{
    ...
    class In {
        ...
        run() {
            ...
            case J.OPT_IN:
            case J.COOKIES_BY_CATEGORY:
                if (this.useConsentFromExistingCookie())
                    break;
            ...
            case J.NOTIFY:
                ...
                if (this.isNotifyBannerDismissCookiePresent())
                    break;
                this.renderBanner();
                break;
            case J.COOKIES_WITHOUT_BANNER:
        ...
        setMatchingSetting(e) {
            ...
            if (0 === this.privacySettingsListeners.length)
                return;
        ...
        setConsent(e, t) {
            const n = {
              ...
              , {persist: o, treatAsConsentEvent: i, reportClick: s} = Object.assign({}, n, t);
            this.consent = e;
            i && this.hideBanner();
        ...
        setConsentCookie() {
            if (!this.matchedSetting || this.isRunningInTestMode)
                return;
        ...
        showBanner() {
            if (this.matchedSetting.policy.type === J.NO_COOKIES || this.matchedSetting.policy.type === J.COOKIES_WITHOUT_BANNER)
                return;
